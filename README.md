...
📚 Currently I am preparing for exams and uni, participating in contests, so I am short on resources to maintain old projects alone.
...
| [Advanced chess analysis](https://github.com/unleex/advanced-chess-analysis) | 🕙 | Project is planned 📆 | Chess tool that reveals tactics, key squares, pinned pieces, instead of simple best moves, helping to navigate in any position easily! | 

## AI projects
| Repo | Creation | Maintenance | Short description | 
| ------------- | ------------- | ------------- | ------------- |
| [Mini Metro RL](https://github.com/unleex/mini-metro-rl)  | 🕙  | Project is planned 📆 | Reinforcement learning algorithm to solve original Mini Metro, with some reverse engineering for fast learning and data extraction.|
